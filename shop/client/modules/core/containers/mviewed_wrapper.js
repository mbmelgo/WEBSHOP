...
import MviewedWrapper from '../components/mviewed_wrapper';
...
export const composer = ({context}, onData) => {
  ...
  if(Meteor.subscribe('mostViewedProducts', LocalState.get("LIMIT")).ready() && Meteor.subscribe('allCategories').ready() ){
